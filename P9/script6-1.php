...
<body>
    ...
    <form action="script6-1proses.php" method="post">
        <table>
            ...
            <tr><td>Alamat</td><td>:</td><td><input type="text" name="alamat" size="30"></td></tr>
            ...
            <tr><td>Status Menikah</td><td>:</td><td><input type="checkbox" name="status" value="Menikah"></td></tr>
        </table>
